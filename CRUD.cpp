...
int main(){
    ...
    do {
        exibirMenu();
		while (!(cin >> opcao)) {
            //Tratamento de exceção para caracteres que não sejam números:
            cout << "Entrada invalida! Por favor, digite um numero (1-7)." << endl;
            // 2. Limpa o "estado de falha" do cin
            cin.clear(); 
            // 3. Descarta a linha inválida que está no buffer (quando executado em Windows)
